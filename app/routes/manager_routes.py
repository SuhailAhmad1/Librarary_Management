...
from app.controllers.manager_controller import get_all_products, add_product, edit_product, delete_product, \
    add_category, delete_category, edit_category, get_alluser_requets, update_user_request_status, get_manager_statistics, \
    get_manager_requests, trigger_generate_csv, read_gen_task_status, download_csv, get_book
...
manager_routes.route("/get_alluser_requets", methods=["GET"])(get_alluser_requets)
manager_routes.route("/update_user_request_status", methods=["PUT"])(update_user_request_status)
...
manager_routes.route("/get_book/<int:product_id>", methods=["GET"])(get_book)